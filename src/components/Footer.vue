<template>
  <footer class="bg-neutral-very-dark-violet pt-16 pb-20">
    <div
      class="container mx-auto flex flex-col gap-y-10 items-center sm:flex-row sm:justify-between sm:items-start"
    >
      <a
        href="/"
        class="text-3xl text-white font-bold tracking-tight sm:w-full"
      >
        Shortly
      </a>
        ...
        <section class="social-media h-fit flex gap-x-5">
          <a href="#" class="group">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
              <path
                class="group-hover:fill-primary-cyan duration-200"
                fill="#FFF"
